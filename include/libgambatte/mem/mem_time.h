...
// Do NOT define feature macros in headers! They belong in CMake or command-line
...
//#include <time.h>     // For clockid_t, CLOCK_MONOTONIC, etc.
#include <cstdint>    // For uint32_t, etc.
#include <unistd.h>   // For usleep or related
